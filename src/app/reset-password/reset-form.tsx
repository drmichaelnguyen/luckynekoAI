  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-gradient-to-b from-amber-50/80 to-background px-4 py-10 dark:from-amber-950/20">
      <div className="mb-6 flex flex-col items-center gap-2 text-center">
        ...
        <h1 className="text-xl font-semibold tracking-tight">{t("reset_password_title")}</h1>
        <p className="max-w-sm text-sm text-muted-foreground">{t("reset_password_invalid")}</p>
      </div>
